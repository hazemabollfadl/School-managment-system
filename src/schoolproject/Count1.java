...
class Count1 {
    ...
    public int call() {
        ...
        try {
            ...
            rs = stm.executeQuery("SELECT id1  FROM vstudent ");
    ...
    public int call2() {
        ...
        try {
            ...
            con = DriverManager.getConnection("jdbc:oracle:thin:@localhost:1521:xe", user, pass);
            stm = con.createStatement();
            rs = stm.executeQuery("SELECT id1  FROM vstaff ");
    ...
    public int call3() {
        ...
        try {
            ...
            con = DriverManager.getConnection("jdbc:oracle:thin:@localhost:1521:xe", user, pass);
            stm = con.createStatement();
            rs = stm.executeQuery("SELECT id1  FROM saccount ");
    ...
    public int call4() {
        ...
        try {
            ...
            con = DriverManager.getConnection("jdbc:oracle:thin:@localhost:1521:xe", user, pass);
            stm = con.createStatement();
            rs = stm.executeQuery("SELECT id1  FROM vcourse ");
