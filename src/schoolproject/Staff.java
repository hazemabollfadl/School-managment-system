...
public class Staff extends JFrame implements ActionListener {
    ...
    public Staff() {
        ...
        //Label
        JLabel toplabel = new JLabel("Staff form");
        ...
        Designation.setBounds(430, 240, 100, 20);
        ...
        submit = new JButton("Add Staff", new ImageIcon("images/add.png"));
        submit.setBounds(200, 490, 100, 30);
        reset = new JButton("Reset", new ImageIcon("images/clear.png"));
        reset.setBounds(400, 490, 110, 30);
        ...
        if (e.getSource() == submit) {
            ...
            if (Staff1.isEmpty() || Staff2.isEmpty() || Staff3.isEmpty() || Staff4.isEmpty() || Staff5.isEmpty() || Staff6.isEmpty() || Staff7.isEmpty() || Staff8.isEmpty() || Staff9.isEmpty() || Staff10.isEmpty() || Staff11.isEmpty() || Staff12.isEmpty() || Staff13.isEmpty() || Staff14.isEmpty() || Staff15.isEmpty() || Staff16.isEmpty() || Staff17.isEmpty()) {
                ...
                try {
                    ...
                    rs2 = stm2.executeQuery("Select * from vstaff");
                    while (rs2.next()) {
                        if (Staff1.equals(rs2.getString(1))) {
                            ch1 = 1;
                            break;
                        }
                    }
                ...
                String i1 = ltextf5.getText();
                String i2 = ltextf1.getText();
