    ...
    public Admission() {
        ...
        choice5.addItemListener(new ItemListener() {
            public void itemStateChanged(ItemEvent v) {
                ltf9.setText((String) choice5.getSelectedItem());
            }
        });
...
//                            
                ...
                if (ch1 == 0) {
                    if (pass9 == 0) {
                        ...
                        if (ph3 == 1) {
                            JOptionPane.showMessageDialog(this, "Student ID only number accepted", "Error", JOptionPane.ERROR_MESSAGE);
                        }
                    }
                } else {
                    if (ch1 == 1) {
                        JOptionPane.showMessageDialog(this, "Student ID already added", "Error", JOptionPane.ERROR_MESSAGE);
                    }
                }
