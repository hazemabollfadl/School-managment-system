...
public class StudentRecord extends JFrame implements ActionListener {
    ...
    JTextField tf1;
    JButton b1, b2;
    String columns[] = {"Student ID", "First Name", "Last Name", "Father Name", "Address", "Gender", "DOB", "join", "Section", "Phone no", "Email", "Caste", "Religion", "Nationality", "ID Mark", "password"};
    TableModel tmodel;
    JTable jtable;
    ...
    public StudentRecord() {
        ...
        try {
            ...
            rs = stm.executeQuery("SELECT *  FROM vstudent ");
        ...
        JLabel l1 = new JLabel("Search Fees Record");
