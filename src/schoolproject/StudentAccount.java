...
public class StudentAccount extends JFrame implements ActionListener {
    ...
    JLabel StudentID, Fname, Lname, Section, Dateofpay, Modeofpay, Amount;
    ...
    public StudentAccount() {
        ...
        StudentID.setBounds(200, 60, 100, 20);
        Fname = new JLabel("First Name:");
        Fname.setBounds(200, 90, 100, 20);
        Lname = new JLabel("Last Name:");
        Lname.setBounds(200, 120, 100, 20);
        Section = new JLabel("Section:");
        Section.setBounds(200, 150, 100, 20);
        Dateofpay = new JLabel("Date of pay:");
        Dateofpay.setBounds(200, 180, 100, 20);
        Modeofpay = new JLabel("Mode of pay:");
        Modeofpay.setBounds(200, 210, 100, 20);
        Amount = new JLabel("Amount:");
        Amount.setBounds(200, 240, 100, 20);

        panel2.add(StudentID);
        panel2.add(Fname);
        panel2.add(Lname);
        panel2.add(Section);
        panel2.add(Dateofpay);
        panel2.add(Modeofpay);
        panel2.add(Amount);
