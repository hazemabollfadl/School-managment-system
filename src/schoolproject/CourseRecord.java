...
public class CourseRecord extends JFrame implements ActionListener {

    JTextField tf1;
    JButton b1, b2;
    String columns[] = {"Course ID", "Course code", "Course Name", "Course fee", "Course Duraton"};
    TableModel tmodel;
    JTable jtable;
    ...
    public CourseRecord() {
        ...
        try {
            ...
            rs = stm.executeQuery("SELECT *  FROM vcourse ");
        ...
        JLabel l1 = new JLabel("Course Record");
